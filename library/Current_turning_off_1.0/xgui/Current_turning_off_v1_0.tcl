...
proc update_PARAM_VALUE.C_DELAY_MS { PARAM_VALUE.C_DELAY_MS } {
	# Procedure called to update C_DELAY_MS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_DELAY_MS { PARAM_VALUE.C_DELAY_MS } {
	# Procedure called to validate C_DELAY_MS
	return true
}
...
proc update_MODELPARAM_VALUE.C_DELAY_MS { MODELPARAM_VALUE.C_DELAY_MS PARAM_VALUE.C_DELAY_MS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_DELAY_MS}] ${MODELPARAM_VALUE.C_DELAY_MS}
}
