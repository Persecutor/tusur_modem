...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DMA_DATA_WIDTH_SRC" -parent ${Source} -widget comboBox
  ...
  ipgui::add_param $IPINST -name "DMA_DATA_WIDTH_DEST" -parent ${Destination} -widget comboBox
