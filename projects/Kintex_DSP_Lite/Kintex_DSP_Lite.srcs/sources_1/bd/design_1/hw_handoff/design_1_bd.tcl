...
# module references:
# only_rx, only_tx, switch, FPGA_reset, ibuf, Decoder_SPI, on_off_wire, on_off_wire, RAshift16_4_up, RAshift16_4_up, RAshift16_4_up, RAshift16_4_up, RAshift16_4_up, RAshift16_4_up, RAshift16_4_up, RAshift16_4_up, RAshift16_4_up, RAshift16_4_up, RAshift16_4_up, RAshift16_4_up
...
proc create_root_design { parentCell } {
  ...
  # Create port connections
  connect_bd_net -net AD9361_CTRL_clk_out1 [get_bd_pins AD9361_CTRL/clk_out1] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins only_rx_0/clk_l] [get_bd_pins only_rx_0/rx_i_axis_aclk] [get_bd_pins only_rx_0/rx_q_axis_aclk] [get_bd_pins only_tx_0/clk_l] [get_bd_pins only_tx_0/s_axis_aclk] [get_bd_pins only_tx_0/tx_i_axis_aclk] [get_bd_pins only_tx_0/tx_q_axis_aclk]
  ...
  connect_bd_net -net clk_wiz_0_axi_periph_clk [get_bd_pins AD9361_CTRL/s_axi_aclk] [get_bd_pins AD9364/s_axi_aclk] [get_bd_pins AXI_Peripheral/m_aclk] [get_bd_pins CLK_AXI/axi_periph_clk] [get_bd_pins Control_from_SOM_0/s00_axi_aclk] [get_bd_pins Current_turning_off_0/s00_axi_aclk] [get_bd_pins SPI_MOD/s_axi4_aclk]
  ...
  connect_bd_net -net xlconstant_4_dout [get_bd_pins only_tx_0/s_axis_tlast] [get_bd_pins only_tx_0/s_axis_tuser] [get_bd_pins only_tx_0/s_axis_tvalid] [get_bd_pins xlconstant_4/dout]
